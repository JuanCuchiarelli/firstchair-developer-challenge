...
## Part 4: Optional - External API Integration

### Files
* accountWeather/accountWeather.html - Weather component template
* accountWeather/accountWeather.js - Weather component JavaScript controller
* accountWeather/accountWeather.cs - Weather component styles
* accountWeather/accountWeather.js-meta.xml - Weather component metadata
* WeatherController.cls - Apex controller for WeatherAPI integration
* WeatherController.cls-meta.xml - Weather controller metadata
* WeatherControllerTest.cls - Test class with HTTP mocks
* WeatherControllerTest.cls-meta.xml - Test class metadata

I built a Lightning Web Component that integrates with WeatherAPI.com to display current weather conditions for an Account's billing city.
